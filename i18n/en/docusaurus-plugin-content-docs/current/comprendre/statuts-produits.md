...
Each product follows a lifecycle that reflects its progress, from the initial proposal to on-site installation.
...
| **Installed** | The product has been installed | Yes |
...
You can also change the status of multiple products in bulk via [Select products](/produits/selection).
