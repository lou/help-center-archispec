...
Échangez avec votre équipe et vos clients directement dans le projet, sans quitter Archispec.
...
Le chat du projet comporte deux canaux :

### Canal interne

- Visible par **l'équipe uniquement**
- Idéal pour les échanges internes (questions techniques, arbitrages, notes de travail)
